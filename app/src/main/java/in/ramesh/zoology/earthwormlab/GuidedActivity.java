...
public final class GuidedActivity extends Activity {
    ...
    @Override public void onCreate(Bundle b){
        ...
        lang.setMinHeight(dp(56));root.addView(lang,new LinearLayout.LayoutParams(-1,-2));
        ...
        prev.setMinHeight(dp(56));prev.setPadding(dp(8),dp(8),dp(8),dp(8));nav.addView(prev,new LinearLayout.LayoutParams(0,-2,1));
        next.setMinHeight(dp(56));next.setPadding(dp(8),dp(8),dp(8),dp(8));nav.addView(next,new LinearLayout.LayoutParams(0,-2,1));
        root.addView(nav);
