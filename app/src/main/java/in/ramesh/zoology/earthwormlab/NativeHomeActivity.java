...
public final class NativeHomeActivity extends Activity {
    ...
    @Override public void onCreate(Bundle savedInstanceState){
        ...
        Button assessment=button("Native assessment");assessment.setOnClickListener(v->startActivity(new Intent(this,AssessmentActivity.class)));body.addView(assessment,new LinearLayout.LayoutParams(-1,dp(52)));
