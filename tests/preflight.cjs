...
check(native.includes('Android features: bundled offline lessons (no remote website is loaded), native text-to-speech, Android print/save'),'Native dashboard describes Android-specific functionality');
